...
**最近公共祖先的定义：** 设节点 root为节点 p*,*q 的某公共祖先，若其左子节点 root.left和右子节点 root.right 都不是 p*,*q 的公共祖先，则称 root是 “最近的公共祖先” 。

![Picture1.png](https://pic.leetcode-cn.com/1599885247-rxcHcZ-Picture1.png)

![image-20210717103919744](C:\Users\Wanan\AppData\Roaming\Typora\typora-user-images\image-20210717103919744.png)

![Picture2.png](https://pic.leetcode-cn.com/1599885247-mgYjRv-Picture2.png)

考虑通过递归对二叉树进行先序遍历，当遇到节点 *p* 或 *q* 时返回。从底至顶回溯，当节点 p*,*q在节点 root的异侧时，节点 root即为最近公共祖先，则向上返回 root。

![image-20210717103714732](C:\Users\Wanan\AppData\Roaming\Typora\typora-user-images\image-20210717103714732.png)
...
![image-20210718112957683](C:\Users\Wanan\AppData\Roaming\Typora\typora-user-images\image-20210718112957683.png)
